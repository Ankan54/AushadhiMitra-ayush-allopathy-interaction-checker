...
EXISTING_AGENTS = {
    ...
    "reasoning": {
        ...
        "alias": os.environ.get("REASONING_AGENT_LIVE_ALIAS", "DUH94OH0OG"),
    },
    "supervisor": {
        "id": os.environ.get("SUPERVISOR_AGENT_ID", "8MIQNGTVWG"),
        "alias": os.environ.get("SUPERVISOR_AGENT_LIVE_ALIAS", "IPQMNOORBI"),
    },
}
